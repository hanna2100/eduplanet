            ...
            <article class="article_ty2">
                ...
                <div id="section_wrap1">
                  ...
                  <div id="section_bottom">
                    <p class="section_bottom">
                      <a href="/eduplanet/acd_list/view_all.php?district=전체&sort=star_max" class="btn_rnd btn_rnd_arrow"><span class="txt">전체보기</span><span class="arrow"></span></a>
                    </p>
                  </div>
                </div>
              ...
              <section class="card_ty1">
                ...
                <div id="section_wrap1">
                  ...
                  <div id="section_bottom">
                    <p class="section_bottom">
                      <a href="/eduplanet/acd_list/view_all.php?district=전체&sort=facility_max" class="btn_rnd btn_rnd_arrow"><span class="txt">전체보기</span><span class="arrow"></span></a>
                    </p>
                  </div>
                </div>
              ...
              <section class="card_ty1">
                ...
                <div id="section_wrap1">
                  ...
                  <div id="section_bottom">
                    <p class="section_bottom">
                      <a href="/eduplanet/acd_list/view_all.php?district=전체&sort=acsbl_max" class="btn_rnd btn_rnd_arrow"><span class="txt">전체보기</span><span class="arrow"></span></a>
                    </p>
                  </div>
                </div>
              ...
              <section class="card_ty1">
                ...
                <div id="section_wrap1">
                  ...
                  <div id="section_bottom">
                    <p class="section_bottom">
                      <a href="/eduplanet/acd_list/view_all.php?district=전체&sort=teacher_max" class="btn_rnd btn_rnd_arrow"><span class="txt">전체보기</span><span class="arrow"></span></a>
                    </p>
                  </div>
                </div>
              ...
              <section class="card_ty1">
                ...
                <div id="section_wrap1">
                  ...
                  <div id="section_bottom">
                    <p class="section_bottom">
                      <a href="/eduplanet/acd_list/view_all.php?district=전체&sort=cost_efct_max" class="btn_rnd btn_rnd_arrow"><span class="txt">전체보기</span><span class="arrow"></span></a>
                    </p>
                  </div>
                </div>
              ...
              <section class="card_ty1">
                ...
                <div id="section_wrap1">
                  ...
                  <div id="section_bottom">
                    <p class="section_bottom">
                      <a href="/eduplanet/acd_list/view_all.php?district=전체&sort=achievement_max" class="btn_rnd btn_rnd_arrow"><span class="txt">전체보기</span><span class="arrow"></span></a>
                    </p>
                  </div>
                </div>
