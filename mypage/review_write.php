                    ...
                    <div class="mypage_content_aside_menu_title">
                        ...
                        <ul>
                            ...
                            <a href="/eduplanet/mypage/review_write.php">
                                <li id="select_aside_menu">리뷰 작성하기</li>
                            </a>
                        </ul>
                    </div>
                </div>
                ...
                <div class="mypage_content">
                    ...
                    ?>
                        ...
                        <div class="mypage_content_list">
                            ...
                            <div class="mambership_table_header">
                                <ul>
                                    ...
                                    <li id="header_mambership_pay_day">결제일자</li>
                                </ul>
                            </div>
                            ...
                            <div class="membership_table_list">
                                <ul>
                                    ...
                                    <li id="mambership_pay_day">2020-02-18</li>
                                </ul>
                            </div>
                            ...
                            <div class="membership_table_list">
                                <ul>
                                    ...
                                    <li id="membership_status">결제완료</li>
                                    <li id="mambership_pay_day">2020-02-01</li>
                                </ul>
                            </div>
                            ...
                            <div class="membership_table_list">
                                <ul>
                                    ...
                                    <li id="mambership_pay_day">2020-01-18</li>
                                </ul>
                            </div>
                        </div>
