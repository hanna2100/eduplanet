...
<body>
  ...
  <main>
    ...
    <div id="eduInforMain">
      ...
      <!-- 정보 수정 레이어 -->
      <div id="addInfo">
        <form id="edit_form" action="/eduplanet/academy/index_edit.php?no=<?=$no?>" method="post" enctype="multipart/form-data">
            ...
            <div class="edit_div">
              ...
              <ul>
                ...
                <li>
                  ...
                  <img id="preview" src="/eduplanet/data/acd_logo/<?= $file_copy ?>" alt="미리보기" width="100" height="100">
                  <br><br><p>* 파일 선택을 하지 않으시면 기존의 로고가 유지됩니다.</p>
                </li>
